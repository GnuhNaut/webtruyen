    ...
    <div class="container">
      <div class="row m-0 p-0 text-left">
        <div class="col-md-5 col-sm-12 m-0 px-5">
          <h5>
            <img class="footer-logo-img" src="../assets/img/logo.png" alt />
            Doc Truyen Online
          </h5>
          <p
            class="text-left"
        ...
        <div class="col-md-2 col-sm-4 m-0 p-1">
          <ul class="text-left list-nostyle">
              ...
              <li>Truyện Quân Sự</li>
              <li>Truyện Xuyên Không</li>
        ...
        <div class="col-md-3 col-sm-4 m-0 p-1">
            ...
            <ul class="text-left list-nostyle d-inline-block social-icon">
                <li>
                    <img src="../assets/img/social/facebook.png" alt=""> face/Webtruyen
                </li>
                <li>
                    <img src="../assets/img/social/google.png" alt=""> google/Webtruyen
                </li>
                <li>
                    <img src="../assets/img/social/skype.png" alt=""> skype/Webtruyen
                </li>
            </ul>
        </div>
      </div>
      <div class="row m-0 p-0 pt-2 border-top text-left">
          <div class="col-md-6 col-sm-4 p-0 pl-4">
              <ul class="list-nostyle d-flex flex-wrap">
                  <li class="pr-2 vs-navbar-before">
                    ...
                    <span class="vs-navbar-after" style="background: rgb(255, 255, 255);"></span>
                  </li>
                  <li class="vs-navbar-before">
                    <a href="/feedback" class="p-0">Feedback</a>
                    <span class="vs-navbar-after" style="background: rgb(255, 255, 255);"></span>
                  </li>
              </ul>
          </div>
          <div class="col-md-6 col-sm-8 p-0">
              <ul class="list-nostyle d-flex flex-wrap">
                  ...
                  <li class="pr-2 vs-navbar-before">
                    <a href="/news" class="p-0">Term of us</a>
                    <span class="vs-navbar-after" style="background: rgb(255, 255, 255);"></span>
                  </li>
                  <li class="pr-2 vs-navbar-before">
                    Hotline :093950824
...
.list-nostyle a:hover~.vs-navbar-after {
    width: 70%;
}
.partner-card{
    width: 50px;
