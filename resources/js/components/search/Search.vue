          ...
          <div class="col-lg-8 pr-0">
            <div class="card mb-3 border-0">
              <div class="row no-gutters">
                <div class="col-12">
                  <div class="card-body">
                    <h5 class="card-title text-left" >Kết quả tìm kiếm truyện: <strong>{{key}}</strong></h5>
                    <ul class="py-1 my-0">
                        <li class="d-flex flex-row text-justify border-item" v-for="item in search" :key="item.id">
